    ...
    void Update()
    {
        ...
        if(fingerDown)
        {
            if(Input.mousePosition.y >= startPos.y + pixelDistToDetect)
            {
                fingerDown = false;
                Debug.Log("Swipe up");
                //player.Move(Vector3.forward * player.moveSpeed);
            ...
            else if(Input.mousePosition.x <= startPos.x - pixelDistToDetect)
            {
                ...
                //player.Move(Vector3.left * player.moveSpeed);
            ...
            else if(Input.mousePosition.x >= startPos.x + pixelDistToDetect)
            {
                ...
                //player.Move(Vector3.right * player.moveSpeed);
            ...
            else if(Input.mousePosition.y <= startPos.y - pixelDistToDetect)
            {
                ...
                //player.Move(Vector3.back * player.moveSpeed);
